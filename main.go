...
func main() {
	...
	http.HandleFunc("/deleteReport", func(w http.ResponseWriter, r *http.Request) { functions.DeleteReport(w, r, db) })

	//handle the error requests
	http.HandleFunc("/ban", func(w http.ResponseWriter, r *http.Request) { http.ServeFile(w, r, "tmpl/ban.html") })
